...
/** Notify admin of a new contact form enquiry */
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 24px; border-radius: 8px 8px 0 0;">
            <h1 style="color: #c6962c; margin: 0; font-size: 20px;">New Contact Enquiry</h1>
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #ffffff; padding: 32px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
            ...
            <p style="color: #4b5563; font-size: 14px; line-height: 1.6;">
              Hi ${data.name.split(" ")[0]}, we've received your message and one of our buyer's agents will be in touch within 24 hours.
            </p>
            <p style="color: #4b5563; font-size: 14px; line-height: 1.6;">
