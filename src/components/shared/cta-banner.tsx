...
export function CTABanner({
  ...
  return (
    <section className="gradient-hero relative overflow-hidden py-16 lg:py-20">
      ...
      <div className="pointer-events-none absolute -bottom-1/3 -left-[10%] h-[400px] w-[400px] rounded-full bg-gold/[0.03]" />
      ...
      <div className="relative mx-auto max-w-[700px] px-6 text-center lg:px-8">
        ...
        <p className="mx-auto mt-4 mb-8 max-w-[500px] text-base leading-relaxed text-gold-muted/80">
          {subtitle}
        </p>
